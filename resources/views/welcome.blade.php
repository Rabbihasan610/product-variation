                            ...
                            <fieldset>
                               <div class="row">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text" name="title" id="productTitle" class="form-control" id="exampleFormControlInput1">
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label for="exampleFormControlInput2" class="form-label">Category</label>
                                        <select name="category_id" class="form-select" aria-label="Default select example" id="exampleFormControlInput2">
                               ...
                               <div class="row">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text" name="sku" class="form-control" id="exampleFormControlInput3">
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label for="exampleFormControlInput4" class="form-label">Unit</label>
                                        <input type="text" name="sku" class="form-control" id="exampleFormControlInput4">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        <input type="checkbox" name="add_varient" class="custom-checkbox" id="checkboxEvent">
                                ...
                                <div class="row" id="rowToToggle" style="display:none;">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <div>
                                            <select class="js-example-basic-multiple" id="attribute" multiple="multiple">
                                                @foreach ($attributes as $attribute)
                                                    <option value="{{ $attribute->id }}" data-id="{{ $attribute->id }}">{{ $attribute->title }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <div>
                                            <select class="js-example-basic-multiple" id="attributeValue" multiple="multiple">
            ...
            $(document).ready(function() {
                    ...
                    $.ajax({
                        ...
                        success: function(res){
                            ...
                            for (var i = 0; i < res.data.length; i++) {
                                attributeValue.append('<option value="' + res.data[i].id + '" data-id="' + res.data[i].id + '">' + res.data[i].title + '</option>');
                            }
                        }
                    })
                });
                ...
                $("#attributeValue").change(function(){
                    ...
                    $.ajax({
                        ...
                        success: function(res){
                            if (res.status === true && res.data !== undefined && res.data !== null) {
                    ...
                    for (var i = 0; i < values.length; i++) {
                        option_attrs += `
                            <div class="row mb-3">
                                ...
                                <div class="col-md-3">
                                    <input type="text" class="form-control" name="var_unit[]" value="">
                                </div>
                            </div>
                        `;
                    }
